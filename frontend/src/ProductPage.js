      ...
      <div className="row">
            ...
            <div className="collapse" id="brandCollapse">
              <div className="pb-3">
                <div className="form-check mb-3">
                  ...
                  <label className="form-check-label text-muted" htmlFor="brand1" style={{ fontSize: '15px' }}>BenQ Zowie</label>
                </div>
                <div className="form-check mb-3">
                  <input className="form-check-input shadow-none border-secondary" type="checkbox" id="brand2" />
                  <label className="form-check-label text-muted" htmlFor="brand2" style={{ fontSize: '15px' }}>Lamzu</label>
                </div>
                <div className="form-check mb-3">
                  <input className="form-check-input shadow-none border-secondary" type="checkbox" id="brand3" />
                  <label className="form-check-label text-muted" htmlFor="brand3" style={{ fontSize: '15px' }}>Logitech</label>
                </div>
                <div className="form-check mb-2">
                  <input className="form-check-input shadow-none border-secondary" type="checkbox" id="brand4" />
                  <label className="form-check-label text-muted" htmlFor="brand4" style={{ fontSize: '15px' }}>Pulsar</label>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="collapse" id="priceCollapse">
              <div className="pb-3 pt-2">
                ...
                <div className="d-flex align-items-center justify-content-between">
                  ...
                  <div className="position-relative" style={{ width: '42%' }}>
                    <span className="position-absolute top-50 translate-middle-y text-muted ms-2" style={{ fontSize: '14px' }}>đ</span>
                    <input type="number" className="form-control text-secondary text-end shadow-none" defaultValue="539000" style={{ paddingLeft: '24px', fontSize: '15px' }} />
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="col-md-9">
          ...
          <div className="row g-4" id="product-list-container">
            {/* Component sản phẩm sẽ được render vào đây */}
          </div>
        </div>
      </div>
    </main>
